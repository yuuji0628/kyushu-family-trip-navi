...
async function articlesPage(env, url) {
  ...
  return layout("記事一覧｜九州ファミリー旅ナビ", body,
...
async function articlePage(env, url) {
  ...
  return layout(a.title + "｜九州ファミリー旅ナビ", body, head);
}
...
(function(){
  ...
  return layout("管理画面｜九州ファミリー旅ナビ", body, '<meta name="robots" content="noindex,nofollow">');
}
